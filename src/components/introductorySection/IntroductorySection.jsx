...
const images = [
  "https://file.hstatic.net/200000420363/file/slider_1_image_fc5568fef7374019986e1a38ac82ad26.jpg",
  "https://file.hstatic.net/200000420363/file/sli-asus_8426a9a368cb4e11b6319b4d7d2eac6e.jpg",
  "https://file.hstatic.net/200000420363/file/slider_3_image_a51ce838ff07489f89b71c0f13c94bf1.jpg",
];
        ...
        <div className="row">
          ...
          <div className="col-12 p-0 d-none d-md-flex">
            ...
            <div className="row introductory-wrapper introductory-ad-carousel">
              ...
              {/* BOTTOM ADS */}
              <div className="col-md-12 col-lg-12 d-flex p-0 w-100 bottom-ads">
                <img
